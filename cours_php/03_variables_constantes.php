...
echo $phrase2;
//Pour que le °C soit coller, ne pas avoir d'espaces ont ajoute les accolades {}
...
//  echo $string1;
//  echo gettype($string1); // POUR AFFICHER LE TYPE , ont ajoute gettype  aprés echo 
$string2 = (float)'12.5';
...
echo gettype($chaine);
echo "<br>";
$entier = (int)$chaine; // int fonction qui va transformer $tring en intiger = en entier  
echo $entier;
echo "<br>";
echo gettype($entier);
...
echo CHAINE .'<br>'; // concaténer avec un br
define('ENTIER', 30);
//  define('ENTIER', '30');
echo ENTIER .'<br>';
...
// Ont doit utiliser la concaténation avec les doubles quotes ou une simple quotes
...
//  const NBR_AU_PIF = rand(1,10); // cela ne  fonctionner pas , ont utlisera  define 
...
echo __LINE__; // la ligne où ont se trouve / Ligne 301

echo __DIR__; // le Chemin où ont se trouve -> C:\xampp\htdocs\cours_php 
